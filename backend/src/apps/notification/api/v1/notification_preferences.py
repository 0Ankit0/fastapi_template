...
async def get_preferences(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Error retrieving notification preferences: {str(exc)}",
        )
...
async def update_preferences(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error updating notification preferences: {str(exc)}",
        )
...
async def register_push_subscription(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error registering push subscription: {str(exc)}",
        )
...
async def remove_push_subscription(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail=f"Error removing push subscription: {str(exc)}",
        )
