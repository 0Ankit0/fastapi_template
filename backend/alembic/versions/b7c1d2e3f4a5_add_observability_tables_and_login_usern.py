...
def upgrade() -> None:
    ...
    with op.batch_alter_table("loginattempt", schema=None) as batch_op:
        batch_op.add_column(sa.Column("attempted_username", sa.String(length=150), nullable=False, server_default=""))
    ...
    op.create_table(
        ...
        sa.Column("metadata", sa.JSON(), nullable=True),
        sa.Column("review_notes", sa.String(length=2048), nullable=False),
