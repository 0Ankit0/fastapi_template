class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      isConfirmed: (json['is_confirmed'] ?? json['isVerified'] ?? json['isConfirmed']) as bool? ?? false,
      isActive: (json['is_active'] ?? json['isActive']) as bool? ?? true,
      isSuperuser: (json['is_superuser'] ?? json['isSuperuser']) as bool? ?? false,
      otpEnabled: (json['otp_enabled'] ?? json['otpEnabled']) as bool? ?? false,
      otpVerified: (json['otp_verified'] ?? json['otpVerified']) as bool? ?? false,
      firstName: (json['first_name'] ?? json['firstName']) as String?,
      lastName: (json['last_name'] ?? json['lastName']) as String?,
      phone: json['phone'] as String?,
      imageUrl: (json['image_url'] ?? json['imageUrl'] ?? json['avatar']) as String?,
