...
2. Read [project-orientation.md](../../docs/onboarding/project-orientation.md) and [template-finalization-checklist.md](../../docs/onboarding/template-finalization-checklist.md).
